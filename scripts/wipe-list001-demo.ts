// Companion to seed-list001-demo.ts. Removes everything tagged with the
// shared "list001-demo" prefix.
//
// Run with: node --experimental-strip-types scripts/wipe-list001-demo.ts
